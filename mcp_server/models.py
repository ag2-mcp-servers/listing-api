...
class Aspect(BaseModel):
    name: Optional[str] = Field(
        None, description='The name of an aspect, such and Brand.'
    )
...
class Charity(BaseModel):
    ...
    donationPercentage: Optional[str] = Field(
        None,
...
class ItemDraftResponse(BaseModel):
    itemDraftId: Optional[str] = Field(
        None, description='The eBay generated ID of the listing draft.'
    )
    sellFlowNativeUri: Optional[str] = Field(
        None,
    ...
    sellFlowUrl: Optional[str] = Field(
        None,
...
class PricingSummary(BaseModel):
    auctionReservePrice: Optional[Amount] = Field(
        None,
    ...
    auctionStartPrice: Optional[Amount] = Field(
        None,
    ...
    price: Optional[Amount] = Field(
        None, description='The Buy It Now Price for the item.'
    )
...
class ItemDraft(BaseModel):
    ...
    charity: Optional[Charity] = Field(
        None,
